...
locals {
  primary_location_fmt   = replace(lower(var.primary_location), " ", "")
  secondary_location_fmt = replace(lower(var.secondary_location), " ", "")

  app_service_name_primary   = "${var.app_service_name}-${local.primary_location_fmt}"
  app_service_name_secondary = "${var.app_service_name}-${local.secondary_location_fmt}"

  app_service_plan_name_primary   = "${var.app_service_plan_name}-${local.primary_location_fmt}"
  app_service_plan_name_secondary = "${var.app_service_plan_name}-${local.secondary_location_fmt}"

  app_service_application_insights_name_primary   = "${var.app_service_application_insights_name}-${local.primary_location_fmt}"
  app_service_application_insights_name_secondary = "${var.app_service_application_insights_name}-${local.secondary_location_fmt}"
